# Generated by Django 5.0.4 on 2024-07-11 14:45
...
def reset_delivery_and_warranty(apps, schema_editor):
    order_model = apps.get_model("main_app", "Order")
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_delivery_and_warranty, reset_delivery_and_warranty)
    ]
