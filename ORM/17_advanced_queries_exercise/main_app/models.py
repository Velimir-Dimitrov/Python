...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[
            RangeValidator(1990, 2023, message="The release year must be between 1990 and 2023"),
        ],
    )
...
class Invoice(models.Model):
    ...
    @classmethod
    def get_invoice_with_billing_info(cls, invoice_number: str) -> "QuerySet":
        return cls.objects.select_related().get(invoice_number=invoice_number)
