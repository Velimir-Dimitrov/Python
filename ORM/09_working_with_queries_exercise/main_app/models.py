...
from main_app.choices import BrandTypes, OStypes
...
class Laptop(models.Model):
    brand = models.CharField(max_length=20, choices=BrandTypes.choices)
    ...
    operation_system = models.CharField(max_length=20,choices=OStypes.choices)
    price = models.DecimalField(max_digits=10, decimal_places=2)
