# Generated by Django 5.0.4 on 2024-08-03 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commander', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commanders', to='main_app.astronaut')),
                ('spacecraft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='spacecrafts', to='main_app.spacecraft')),
            ],
            options={
                'abstract': False,
            },
